    ...
    public static class ValudUnionExtensions
    {
        ...
        public static ValueUnion ConvertToValueUnion(this object value)
        {
            ...
            if (value is JsonElement element)
            {
                switch (element.ValueKind)
                {
                    case JsonValueKind.Number:
                        {
                            if (element.TryGetInt32(out int intValue))
                            {
                                ...
                                result.Value_ = new Integer32T { Value = intValue };
                                return result;
                            }
                            ...
                            if (element.TryGetDouble(out double doubleValue))
                            {
                                ...
                                result.Value_ = new DoubleT { Value = intValue };
                                return result;
                            }
                    ...
                    case JsonValueKind.String:
                    {
                        ...
                        result.Value_ = new StringT { Value = element.ToString() };
                        return result;
                    }
                    ...
                    case JsonValueKind.False:
                    {
                        ...
                        result.Value_ = new BooleanT { Value = element.GetBoolean() ? (byte)1 : (byte)0 };
                        return result;
                    }
                    case JsonValueKind.Array:
                    {
                        ...
                        foreach (var itemElement in element.EnumerateArray())
                        {
                            ...
                            {
                                integer32Array[index++] = new Integer32T { Value = intValue };
                            }
                            else
                            {
            ...
            if (value is string stringValue)
            {
                ...
                {
                    result.Type = Value.Boolean;
                    result.Value_ = new BooleanT { Value = boolValue ? (byte)1 : (byte)0 };
                    return result;
                }
                else
                {
                    result.Type = Value.String;
                    result.Value_ = new StringT { Value = stringValue };
                    return result;
                }
            }
            ...
            {
                result.Type = Value.Integer32;
                result.Value_ = new Integer32T { Value = Convert.ToInt32(value) };
                return result;
            }
            ...
            {
                result.Type = Value.Integer32Array;
                result.Value_ = intEnumerableValue.Select(m => new Integer32T { Value = m }).ToArray();
                return result;
            }
            ...
            {
                result.Type = Value.Double;
                result.Value_ = new DoubleT { Value = Convert.ToDouble(value) };
            ...
            {
                result.Type = Value.Boolean;
                result.Value_ = new BooleanT { Value = x ? (byte)1 : (byte)0 };
                return result;
            }
