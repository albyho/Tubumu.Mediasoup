...
namespace FBS.Worker
{
    ...
    public class DumpResponseT
    {
        ...
        {
            this.Pid = 0;
            this.WebRtcServerIds = null;
            this.RouterIds = null;
            this.ChannelMessageHandlers = null;
            this.Liburing = null;
        }
    }
    ...
    static public class DumpResponseVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyVectorOfStrings(tablePos, 6 /*WebRtcServerIds*/, true)
              && verifier.VerifyVectorOfStrings(tablePos, 8 /*RouterIds*/, true)
              && verifier.VerifyTable(tablePos, 10 /*ChannelMessageHandlers*/, FBS.Worker.ChannelMessageHandlersVerify.Verify, true)
              && verifier.VerifyTable(tablePos, 12 /*Liburing*/, FBS.LibUring.DumpVerify.Verify, false)
