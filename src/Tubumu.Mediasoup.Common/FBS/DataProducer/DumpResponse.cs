    ...
    static public class DumpResponseVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 6 /*Type*/, 1 /*FBS.DataProducer.Type*/, 1, false)
              && verifier.VerifyTable(tablePos, 8 /*SctpStreamParameters*/, FBS.SctpParameters.SctpStreamParametersVerify.Verify, false)
              && verifier.VerifyString(tablePos, 10 /*Label*/, true)
              && verifier.VerifyString(tablePos, 12 /*Protocol*/, true)
