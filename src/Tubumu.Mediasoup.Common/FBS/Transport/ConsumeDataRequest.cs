...
namespace FBS.Transport
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(18, 2); }
    ...
    static public class ConsumeDataRequestVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyString(tablePos, 14 /*Protocol*/, false)
              && verifier.VerifyField(tablePos, 16 /*Paused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyVectorOfData(tablePos, 18 /*Subchannels*/, 2 /*ushort*/, false)
