...
namespace FBS.Transport
{
  ...
  public Span<byte> GetAnnouncedAddressBytes() { return __p.__vector_as_span<byte>(8, 1); }
        ...
        public FBS.Transport.PortRange? PortRange { get { int o = __p.__offset(12); return o != 0 ? (FBS.Transport.PortRange?)(new FBS.Transport.PortRange()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public FBS.Transport.SocketFlags? Flags { get { int o = __p.__offset(14); return o != 0 ? (FBS.Transport.SocketFlags?)(new FBS.Transport.SocketFlags()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public uint SendBufferSize { get { int o = __p.__offset(16); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
        public uint RecvBufferSize { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
        ...
        public static Offset<FBS.Transport.ListenInfo> CreateListenInfo(FlatBufferBuilder builder,
            ...
            StringOffset announced_addressOffset = default(StringOffset),
            ushort port = 0,
            Offset<FBS.Transport.PortRange> port_rangeOffset = default(Offset<FBS.Transport.PortRange>),
            ...
            uint recv_buffer_size = 0)
        {
            ...
            ListenInfo.AddPortRange(builder, port_rangeOffset);
            ListenInfo.AddAnnouncedAddress(builder, announced_addressOffset);
        ...
        public static void StartListenInfo(FlatBufferBuilder builder) { builder.StartTable(8); }
        ...
        public static void AddPortRange(FlatBufferBuilder builder, Offset<FBS.Transport.PortRange> portRangeOffset) { builder.AddOffset(4, portRangeOffset.Value, 0); }
        public static void AddFlags(FlatBufferBuilder builder, Offset<FBS.Transport.SocketFlags> flagsOffset) { builder.AddOffset(5, flagsOffset.Value, 0); }
        public static void AddSendBufferSize(FlatBufferBuilder builder, uint sendBufferSize) { builder.AddUint(6, sendBufferSize, 0); }
        public static void AddRecvBufferSize(FlatBufferBuilder builder, uint recvBufferSize) { builder.AddUint(7, recvBufferSize, 0); }
        public static Offset<FBS.Transport.ListenInfo> EndListenInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // ip
            builder.Required(o, 12);  // port_range
            builder.Required(o, 14);  // flags
        ...
        public void UnPackTo(ListenInfoT _o)
        {
            ...
            _o.Port = this.Port;
            _o.PortRange = this.PortRange.HasValue ? this.PortRange.Value.UnPack() : null;
        ...
        public static Offset<FBS.Transport.ListenInfo> Pack(FlatBufferBuilder builder, ListenInfoT _o)
        {
            ...
            var _announced_address = _o.AnnouncedAddress == null ? default(StringOffset) : builder.CreateString(_o.AnnouncedAddress);
            var _port_range = _o.PortRange == null ? default(Offset<FBS.Transport.PortRange>) : FBS.Transport.PortRange.Pack(builder, _o.PortRange);
    ...
    public class ListenInfoT
    {
        ...
        public FBS.Transport.PortRangeT PortRange { get; set; }
    ...
    static public class ListenInfoVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*Protocol*/, 1 /*FBS.Transport.Protocol*/, 1, false)
              && verifier.VerifyString(tablePos, 6 /*Ip*/, true)
              && verifier.VerifyString(tablePos, 8 /*AnnouncedAddress*/, false)
              && verifier.VerifyField(tablePos, 10 /*Port*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyTable(tablePos, 12 /*PortRange*/, FBS.Transport.PortRangeVerify.Verify, true)
              && verifier.VerifyTable(tablePos, 14 /*Flags*/, FBS.Transport.SocketFlagsVerify.Verify, true)
              && verifier.VerifyField(tablePos, 16 /*SendBufferSize*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 18 /*RecvBufferSize*/, 4 /*uint*/, 4, false)
