    ...
    static public class StatsVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 8 /*SctpState*/, 1 /*FBS.SctpAssociation.SctpState*/, 1, false)
              && verifier.VerifyField(tablePos, 10 /*BytesReceived*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 12 /*RecvBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 14 /*BytesSent*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 16 /*SendBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 18 /*RtpBytesReceived*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 20 /*RtpRecvBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 22 /*RtpBytesSent*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 24 /*RtpSendBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 26 /*RtxBytesReceived*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 28 /*RtxRecvBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 30 /*RtxBytesSent*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 32 /*RtxSendBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 34 /*ProbationBytesSent*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 36 /*ProbationSendBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 38 /*AvailableOutgoingBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 40 /*AvailableIncomingBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 42 /*MaxIncomingBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 44 /*MaxOutgoingBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 46 /*MinOutgoingBitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 48 /*RtpPacketLossReceived*/, 8 /*double*/, 8, false)
              && verifier.VerifyField(tablePos, 50 /*RtpPacketLossSent*/, 8 /*double*/, 8, false)
