...
namespace FBS.Transport
{
    ...
    static public class RtpListenerVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyVectorOfTables(tablePos, 4 /*SsrcTable*/, FBS.Common.Uint32StringVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 6 /*MidTable*/, FBS.Common.StringStringVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 8 /*RidTable*/, FBS.Common.StringStringVerify.Verify, true)
