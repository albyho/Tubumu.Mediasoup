...
namespace FBS.Transport
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(6, 1); }
    ...
    static public class ConsumeRequestVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*ConsumerId*/, true)
              && verifier.VerifyString(tablePos, 6 /*ProducerId*/, true)
              && verifier.VerifyField(tablePos, 8 /*Kind*/, 1 /*FBS.RtpParameters.MediaKind*/, 1, false)
              && verifier.VerifyTable(tablePos, 10 /*RtpParameters*/, FBS.RtpParameters.RtpParametersVerify.Verify, true)
              && verifier.VerifyField(tablePos, 12 /*Type*/, 1 /*FBS.RtpParameters.Type*/, 1, false)
              ...
              && verifier.VerifyField(tablePos, 16 /*Paused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyTable(tablePos, 18 /*PreferredLayers*/, FBS.Consumer.ConsumerLayersVerify.Verify, false)
              && verifier.VerifyField(tablePos, 20 /*IgnoreDtx*/, 1 /*bool*/, 1, false)
