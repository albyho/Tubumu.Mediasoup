...
namespace FBS.DataConsumer
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(4, 2); }
        ...
        public static Offset<FBS.DataConsumer.AddSubchannelResponse> CreateAddSubchannelResponse(FlatBufferBuilder builder,
        ...
        public static Offset<FBS.DataConsumer.AddSubchannelResponse> EndAddSubchannelResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // subchannels
            return new Offset<FBS.DataConsumer.AddSubchannelResponse>(o);
        }
        ...
        public static Offset<FBS.DataConsumer.AddSubchannelResponse> Pack(FlatBufferBuilder builder, AddSubchannelResponseT _o)
        {
            if(_o == null)
                return default(Offset<FBS.DataConsumer.AddSubchannelResponse>);
    ...
    static public class AddSubchannelResponseVerify
    {
