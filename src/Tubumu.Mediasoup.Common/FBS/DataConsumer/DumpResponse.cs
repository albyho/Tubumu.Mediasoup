    ...
    static public class DumpResponseVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyString(tablePos, 6 /*DataProducerId*/, true)
              && verifier.VerifyField(tablePos, 8 /*Type*/, 1 /*FBS.DataProducer.Type*/, 1, false)
              && verifier.VerifyTable(tablePos, 10 /*SctpStreamParameters*/, FBS.SctpParameters.SctpStreamParametersVerify.Verify, false)
              && verifier.VerifyString(tablePos, 12 /*Label*/, true)
              && verifier.VerifyString(tablePos, 14 /*Protocol*/, true)
              && verifier.VerifyField(tablePos, 16 /*BufferedAmountLowThreshold*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 18 /*Paused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 20 /*DataProducerPaused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyVectorOfData(tablePos, 22 /*Subchannels*/, 2 /*ushort*/, true)
