...
namespace FBS.WebRtcTransport
{
  ...
  public Span<byte> GetAddressBytes() { return __p.__vector_as_span<byte>(8, 1); }
    ...
    static public class IceCandidateVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*Foundation*/, true)
              && verifier.VerifyField(tablePos, 6 /*Priority*/, 4 /*uint*/, 4, false)
              && verifier.VerifyString(tablePos, 8 /*Address*/, true)
              && verifier.VerifyField(tablePos, 10 /*Protocol*/, 1 /*FBS.Transport.Protocol*/, 1, false)
              && verifier.VerifyField(tablePos, 12 /*Port*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 14 /*Type*/, 1 /*FBS.WebRtcTransport.IceCandidateType*/, 1, false)
              && verifier.VerifyField(tablePos, 16 /*TcpType*/, 1 /*FBS.WebRtcTransport.IceCandidateTcpType*/, 1, false)
