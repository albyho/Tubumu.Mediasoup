...
namespace FBS.WebRtcTransport
{
  ...
  public Span<byte> GetRemoteCertBytes() { return __p.__vector_as_span<byte>(6, 1); }
    ...
    static public class DtlsStateChangeNotificationVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*DtlsState*/, 1 /*FBS.WebRtcTransport.DtlsState*/, 1, false)
              && verifier.VerifyString(tablePos, 6 /*RemoteCert*/, false)
