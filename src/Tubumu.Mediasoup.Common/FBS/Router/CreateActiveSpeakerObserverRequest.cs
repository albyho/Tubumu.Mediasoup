...
namespace FBS.Router
{
  ...
  public Span<byte> GetRtpObserverIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
    ...
    static public class CreateActiveSpeakerObserverRequestVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*RtpObserverId*/, true)
              && verifier.VerifyTable(tablePos, 6 /*Options*/, FBS.ActiveSpeakerObserver.ActiveSpeakerObserverOptionsVerify.Verify, true)
