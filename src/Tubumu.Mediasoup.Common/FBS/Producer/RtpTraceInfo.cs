...
namespace FBS.Producer
{
    ...
    public struct RtpTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<FBS.Producer.RtpTraceInfo> CreateRtpTraceInfo(FlatBufferBuilder builder,
        ...
        public static Offset<FBS.Producer.RtpTraceInfo> EndRtpTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // rtp_packet
            return new Offset<FBS.Producer.RtpTraceInfo>(o);
        }
        ...
        public static Offset<FBS.Producer.RtpTraceInfo> Pack(FlatBufferBuilder builder, RtpTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<FBS.Producer.RtpTraceInfo>);
    ...
    static public class RtpTraceInfoVerify
    {
