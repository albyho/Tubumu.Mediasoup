...
namespace FBS.Producer
{
    ...
    public struct GetStatsResponse : IFlatbufferObject
    {
        ...
        public static Offset<FBS.Producer.GetStatsResponse> CreateGetStatsResponse(FlatBufferBuilder builder,
        ...
        public static Offset<FBS.Producer.GetStatsResponse> EndGetStatsResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // stats
            return new Offset<FBS.Producer.GetStatsResponse>(o);
        }
        ...
        public static Offset<FBS.Producer.GetStatsResponse> Pack(FlatBufferBuilder builder, GetStatsResponseT _o)
        {
            if(_o == null)
                return default(Offset<FBS.Producer.GetStatsResponse>);
    ...
    static public class GetStatsResponseVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyVectorOfTables(tablePos, 4 /*Stats*/, FBS.RtpStream.StatsVerify.Verify, true)
