...
namespace FBS.Producer
{
    ...
    static public class VideoOrientationChangeNotificationVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*Camera*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 6 /*Flip*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 8 /*Rotation*/, 2 /*ushort*/, 2, false)
