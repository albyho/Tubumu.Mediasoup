    ...
    static public class DumpResponseVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 8 /*Type*/, 1 /*FBS.RtpParameters.Type*/, 1, false)
              && verifier.VerifyTable(tablePos, 10 /*RtpParameters*/, FBS.RtpParameters.RtpParametersVerify.Verify, true)
              && verifier.VerifyTable(tablePos, 12 /*RtpMapping*/, FBS.RtpParameters.RtpMappingVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 14 /*RtpStreams*/, FBS.RtpStream.DumpVerify.Verify, true)
              && verifier.VerifyVectorOfData(tablePos, 16 /*TraceEventTypes*/, 1 /*FBS.Producer.TraceEventType*/, true)
