...
namespace FBS.Producer
{
    ...
    public struct FirTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<FBS.Producer.FirTraceInfo> CreateFirTraceInfo(FlatBufferBuilder builder,
            uint ssrc = 0)
        {
        ...
        public static Offset<FBS.Producer.FirTraceInfo> EndFirTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<FBS.Producer.FirTraceInfo>(o);
        }
        ...
        public static Offset<FBS.Producer.FirTraceInfo> Pack(FlatBufferBuilder builder, FirTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<FBS.Producer.FirTraceInfo>);
