    ...
    static public class ParamsVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyString(tablePos, 8 /*MimeType*/, true)
              && verifier.VerifyField(tablePos, 10 /*ClockRate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyString(tablePos, 12 /*Rrid*/, false)
              && verifier.VerifyString(tablePos, 14 /*Cname*/, true)
