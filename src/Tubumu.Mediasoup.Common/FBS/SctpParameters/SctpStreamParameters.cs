...
namespace FBS.SctpParameters
{
    ...
    static public class SctpStreamParametersVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*StreamId*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 6 /*Ordered*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 8 /*MaxPacketLifeTime*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 10 /*MaxRetransmits*/, 2 /*ushort*/, 2, false)
