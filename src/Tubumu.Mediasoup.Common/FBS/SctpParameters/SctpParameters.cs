...
namespace FBS.SctpParameters
{
    ...
    static public class SctpParametersVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*Port*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 6 /*Os*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 8 /*Mis*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 10 /*MaxMessageSize*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 12 /*SendBufferSize*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 14 /*SctpBufferedAmount*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 16 /*IsDataChannel*/, 1 /*bool*/, 1, false)
