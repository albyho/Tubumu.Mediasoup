...
namespace FBS.Consumer
{
    ...
    public struct PliTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<FBS.Consumer.PliTraceInfo> CreatePliTraceInfo(FlatBufferBuilder builder,
            uint ssrc = 0)
        {
        ...
        public static Offset<FBS.Consumer.PliTraceInfo> EndPliTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<FBS.Consumer.PliTraceInfo>(o);
        }
        ...
        public static Offset<FBS.Consumer.PliTraceInfo> Pack(FlatBufferBuilder builder, PliTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<FBS.Consumer.PliTraceInfo>);
    ...
    static public class PliTraceInfoVerify
    {
