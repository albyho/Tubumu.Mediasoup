...
namespace FBS.Consumer
{
    ...
    static public class ConsumerDumpVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyTable(tablePos, 4 /*Base*/, FBS.Consumer.BaseConsumerDumpVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 6 /*RtpStreams*/, FBS.RtpStream.DumpVerify.Verify, true)
              && verifier.VerifyField(tablePos, 8 /*PreferredSpatialLayer*/, 2 /*short*/, 2, false)
              && verifier.VerifyField(tablePos, 10 /*TargetSpatialLayer*/, 2 /*short*/, 2, false)
              && verifier.VerifyField(tablePos, 12 /*CurrentSpatialLayer*/, 2 /*short*/, 2, false)
              && verifier.VerifyField(tablePos, 14 /*PreferredTemporalLayer*/, 2 /*short*/, 2, false)
              && verifier.VerifyField(tablePos, 16 /*TargetTemporalLayer*/, 2 /*short*/, 2, false)
              && verifier.VerifyField(tablePos, 18 /*CurrentTemporalLayer*/, 2 /*short*/, 2, false)
