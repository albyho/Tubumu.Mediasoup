...
namespace FBS.Consumer
{
  ...
  public Span<FBS.Consumer.TraceEventType> GetTraceEventTypesBytes() { return __p.__vector_as_span<FBS.Consumer.TraceEventType>(18, 1); }
    ...
    static public class BaseConsumerDumpVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*Id*/, true)
              && verifier.VerifyField(tablePos, 6 /*Type*/, 1 /*FBS.RtpParameters.Type*/, 1, false)
              && verifier.VerifyString(tablePos, 8 /*ProducerId*/, true)
              && verifier.VerifyField(tablePos, 10 /*Kind*/, 1 /*FBS.RtpParameters.MediaKind*/, 1, false)
              && verifier.VerifyTable(tablePos, 12 /*RtpParameters*/, FBS.RtpParameters.RtpParametersVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 14 /*ConsumableRtpEncodings*/, FBS.RtpParameters.RtpEncodingParametersVerify.Verify, true)
              && verifier.VerifyVectorOfData(tablePos, 16 /*SupportedCodecPayloadTypes*/, 1 /*byte*/, true)
              && verifier.VerifyVectorOfData(tablePos, 18 /*TraceEventTypes*/, 1 /*FBS.Consumer.TraceEventType*/, true)
              && verifier.VerifyField(tablePos, 20 /*Paused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 22 /*ProducerPaused*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 24 /*Priority*/, 1 /*byte*/, 1, false)
