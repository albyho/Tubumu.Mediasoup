...
namespace FBS.Consumer
{
  ...
  public Span<byte> GetProducerScoresBytes() { return __p.__vector_as_span<byte>(8, 1); }
    ...
    static public class ConsumerScoreVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyField(tablePos, 4 /*Score*/, 1 /*byte*/, 1, false)
              && verifier.VerifyField(tablePos, 6 /*ProducerScore*/, 1 /*byte*/, 1, false)
              && verifier.VerifyVectorOfData(tablePos, 8 /*ProducerScores*/, 1 /*byte*/, true)
