...
namespace FBS.RtpParameters
{
  ...
  public Span<byte> GetMimeTypeBytes() { return __p.__vector_as_span<byte>(4, 1); }
    ...
    static public class RtpCodecParametersVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*MimeType*/, true)
              && verifier.VerifyField(tablePos, 6 /*PayloadType*/, 1 /*byte*/, 1, false)
              && verifier.VerifyField(tablePos, 8 /*ClockRate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 10 /*Channels*/, 1 /*byte*/, 1, false)
              && verifier.VerifyVectorOfTables(tablePos, 12 /*Parameters*/, FBS.RtpParameters.ParameterVerify.Verify, false)
              && verifier.VerifyVectorOfTables(tablePos, 14 /*RtcpFeedback*/, FBS.RtpParameters.RtcpFeedbackVerify.Verify, false)
