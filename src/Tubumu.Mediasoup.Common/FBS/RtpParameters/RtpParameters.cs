...
namespace FBS.RtpParameters
{
  ...
  public Span<byte> GetMidBytes() { return __p.__vector_as_span<byte>(4, 1); }
    ...
    static public class RtpParametersVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyString(tablePos, 4 /*Mid*/, false)
              && verifier.VerifyVectorOfTables(tablePos, 6 /*Codecs*/, FBS.RtpParameters.RtpCodecParametersVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 8 /*HeaderExtensions*/, FBS.RtpParameters.RtpHeaderExtensionParametersVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 10 /*Encodings*/, FBS.RtpParameters.RtpEncodingParametersVerify.Verify, true)
              && verifier.VerifyTable(tablePos, 12 /*Rtcp*/, FBS.RtpParameters.RtcpParametersVerify.Verify, true)
