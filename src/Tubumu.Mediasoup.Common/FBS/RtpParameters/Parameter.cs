    ...
    static public class ParameterVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 6 /*ValueType*/, 1 /*FBS.RtpParameters.Value*/, 1, false)
              && verifier.VerifyUnion(tablePos, 6, 8 /*Value*/, FBS.RtpParameters.ValueVerify.Verify, true)
