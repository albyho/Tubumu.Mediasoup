...
namespace FBS.RtpParameters
{
    ...
    static public class RtpMappingVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyVectorOfTables(tablePos, 4 /*Codecs*/, FBS.RtpParameters.CodecMappingVerify.Verify, true)
              && verifier.VerifyVectorOfTables(tablePos, 6 /*Encodings*/, FBS.RtpParameters.EncodingMappingVerify.Verify, true)
