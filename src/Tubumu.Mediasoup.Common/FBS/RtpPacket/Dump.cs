    ...
    static public class DumpVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 6 /*SequenceNumber*/, 2 /*ushort*/, 2, false)
              && verifier.VerifyField(tablePos, 8 /*Timestamp*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 10 /*Marker*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 12 /*Ssrc*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 14 /*IsKeyFrame*/, 1 /*bool*/, 1, false)
              && verifier.VerifyField(tablePos, 16 /*Size*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 18 /*PayloadSize*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 20 /*SpatialLayer*/, 1 /*byte*/, 1, false)
              && verifier.VerifyField(tablePos, 22 /*TemporalLayer*/, 1 /*byte*/, 1, false)
              && verifier.VerifyString(tablePos, 24 /*Mid*/, false)
              && verifier.VerifyString(tablePos, 26 /*Rid*/, false)
              && verifier.VerifyString(tablePos, 28 /*Rrid*/, false)
              && verifier.VerifyField(tablePos, 30 /*WideSequenceNumber*/, 2 /*ushort*/, 2, false)
