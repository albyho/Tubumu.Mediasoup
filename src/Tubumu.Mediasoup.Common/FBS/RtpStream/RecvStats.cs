...
namespace FBS.RtpStream
{
    ...
    static public class RecvStatsVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              && verifier.VerifyTable(tablePos, 4 /*Base*/, FBS.RtpStream.StatsVerify.Verify, true)
              && verifier.VerifyField(tablePos, 6 /*Jitter*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 8 /*PacketCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 10 /*ByteCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 12 /*Bitrate*/, 4 /*uint*/, 4, false)
              && verifier.VerifyVectorOfTables(tablePos, 14 /*BitrateByLayer*/, FBS.RtpStream.BitrateByLayerVerify.Verify, true)
