...
namespace FBS.RtpStream
{
  ...
  public Span<byte> GetRidBytes() { return __p.__vector_as_span<byte>(32, 1); }
    ...
    static public class BaseStatsVerify
    {
        static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
        {
            return verifier.VerifyTableStart(tablePos)
              ...
              && verifier.VerifyField(tablePos, 8 /*Kind*/, 1 /*FBS.RtpParameters.MediaKind*/, 1, false)
              && verifier.VerifyString(tablePos, 10 /*MimeType*/, true)
              && verifier.VerifyField(tablePos, 12 /*PacketsLost*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 14 /*FractionLost*/, 1 /*byte*/, 1, false)
              && verifier.VerifyField(tablePos, 16 /*PacketsDiscarded*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 18 /*PacketsRetransmitted*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 20 /*PacketsRepaired*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 22 /*NackCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 24 /*NackPacketCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 26 /*PliCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 28 /*FirCount*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 30 /*Score*/, 1 /*byte*/, 1, false)
              && verifier.VerifyString(tablePos, 32 /*Rid*/, false)
              && verifier.VerifyField(tablePos, 34 /*RtxSsrc*/, 4 /*uint*/, 4, false)
              && verifier.VerifyField(tablePos, 36 /*RtxPacketsDiscarded*/, 8 /*ulong*/, 8, false)
              && verifier.VerifyField(tablePos, 38 /*RoundTripTime*/, 4 /*float*/, 4, false)
